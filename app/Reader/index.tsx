      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            Access authentic books, handouts, and research materials from trusted
            lecturers and institutions.
          </Text>

          <View style={styles.imageWrapper}>
            <Image
              source={require("../../assets/images/authorb1.png")}
              style={styles.image}
              resizeMode="contain"
            />
          </View>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/Reader/ReaderOnboarding2")}
          >
